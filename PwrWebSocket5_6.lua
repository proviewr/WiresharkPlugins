do
  ...
  go.hasChildren = ProtoField.uint16("pwr.getobject.haschildren", "Has Children", base.DEC)
  ...
  gaxc.childHasChildren = ProtoField.uint16("pwr.getallxttchildren.children.hasChildren", "Has Children")
  ...
  gom.enableLang = ProtoField.uint32("pwr.getopwindmenu.enablelang", "Enable Language", base.DEC)
  gom.enableLogin = ProtoField.uint32("pwr.getopwindmenu.enablelogin", "Enable Login", base.DEC)
  gom.enableAlarmList = ProtoField.uint32("pwr.getopwindmenu.enablealarmlist", "Enable Alarm List", base.DEC)
  gom.enableEventLog = ProtoField.uint32("pwr.getopwindmenu.enableeventlog", "Enable Event Log", base.DEC)
  gom.enableNavigator = ProtoField.uint32("pwr.getopwindmenu.enablenavigator", "Enable Navigator", base.DEC)
  gom.disableHelp = ProtoField.uint32("pwr.getopwindmenu.disablehelp", "Disable Help", base.DEC)
  gom.disableProview = ProtoField.uint32("pwr.getopwindmenu.disableproview", "Disable Proview", base.DEC)
  ...
  function setObjectInfoStrReq(buf, subtree)
    ...
    local strDataLen = buf(offset, 2):le_uint()
    payload:add_le(soi.strDataLen, buf(offset, 2))
    offset = offset + 2
  ...
  function getObjectRes(buf, subtree)
    ...
    offset = offset + 4
    payload:add(go.hasChildren, buf(offset, 2))
    offset = offset + 2

    local nameLen = buf(offset, 2):uint()
    payload:add(go.nameLen, buf(offset, 2))
    offset = offset + 2
    if nameLen > 0 then
    ...
    local fullnameLen = buf(offset, 2):uint()
    payload:add(go.fullnameLen, buf(offset, 2))
    offset = offset + 2
    ...
    local classnameLen = buf(offset, 2):uint()
    payload:add(go.classnameLen, buf(offset, 2))
    offset = offset + 2
    ...
    local descLen = buf(offset, 2):uint()
    payload:add(go.descLen, buf(offset, 2))
    offset = offset + 2
    if descLen > 0 then
    ...
    local paramLen = buf(offset, 2):uint()
    payload:add(go.paramLen, buf(offset, 2))
    offset = offset + 2
    if paramLen > 0 then
  ...
  function mhSyncRes(buf, subtree)
    ...
    for i=1,arrLen do
      ...
      local eventTime
      local eventTimeLen = buf(offset, 2)
      offset = offset + 2
      ...
      local eventText
      local eventTextLen = buf(offset, 2)
      offset = offset + 2
      ...
      local eventName
      local eventNameLen = buf(offset, 2)
      offset = offset + 2
      ...
      local eventIDBirthTimeLen = buf(offset, 2)
      offset = offset + 2
      ...
      local eventTargetIDBirthTimeLen = buf(offset, 2)
      offset = offset + 2
      ...
      local eventMoreText
      local eventMoreTextLen = buf(offset, 2)
      offset = offset + 2
  ...
  function mhAckReq(buf, subtree)
    ...
    local birthTimeLen = buf(offset, 2)
  ...
  function checkUserReq(buf, subtree)
    ...
    local usernameLen = buf(offset, 2):le_uint()
    payload:add_le(cu.usernameLen, buf(offset, 2))
    offset = offset + 2
    ...
    local passwordLen = buf(offset, 2):le_uint()
    payload:add_le(cu.passwordLen, buf(offset, 2))
    offset = offset + 2
  ...
  function getAllXttChildrenRes(buf, subtree)
    ...
    for i=1,arrLen do
      ...
      offset = offset + 4
      local childHasChildren = buf(offset, 2)
      offset = offset + 2
      ...
      local childNameLen = buf(offset, 2)
      offset = offset + 2
      ...
      local childDescLen = buf(offset, 2)
      offset = offset + 2
      ...
      local childClassnameLen = buf(offset, 2)
      offset = offset + 2
  ...
  function getOpWindMenuReq(buf, subtree)
    ...
    local opPlaceLen = buf(offset, 2):le_uint()
    payload:add_le(gom.placeLen, buf(offset, 2))
    offset = offset + 2
  ...
  function getOpWindMenuRes(buf, subtree)
    ...
    local titleLen = buf(offset, 2):uint()
    payload:add(gom.titleLen, buf(offset, 2))
    offset = offset + 2
    if titleLen > 0 then
    ...
    local textLen = buf(offset, 2):uint()
    payload:add(gom.textLen, buf(offset, 2))
    offset = offset + 2
    if textLen > 0 then
    ...
    payload:add(gom.enableLang, buf(offset, 4))
    offset = offset + 4

    payload:add(gom.enableLogin, buf(offset, 4))
    offset = offset + 4

    payload:add(gom.enableAlarmList, buf(offset, 4))
    offset = offset + 4

    payload:add(gom.enableEventLog, buf(offset, 4))
    offset = offset + 4

    payload:add(gom.enableNavigator, buf(offset, 4))
    offset = offset + 4

    payload:add(gom.disableHelp, buf(offset, 4))
    offset = offset + 4

    payload:add(gom.disableProview, buf(offset, 4))
    offset = offset + 4

    payload:add(gom.lang, buf(offset, 4))
    offset = offset + 4

    local arrLen = buf(offset, 2):uint()
    payload:add(gom.arrLen, buf(offset, 2))
    offset = offset + 2
    for i=1,arrLen do
      local oldOffset = offset
      ...
      local childTextLen = buf(offset, 2)
      offset = offset + 2
      ...
      local childUrlLen = buf(offset, 2)
      offset = offset + 2
  ...
  function crrSignalRes(buf, subtree)
    ...
    local arrLen = buf(offset, 2):uint()
    payload:add(crr.arrLen, buf(offset, 2))
    offset = offset + 2
    for i=1,arrLen do
      local oldOffset = offset
  ...
  function getMsgRes(buf, subtree)
    ...
    local msgTextLen = buf(offset, 2):uint()
    payload:add(gmt.msgTextLen, buf(offset, 2))
    offset = offset + 2
